  ...
  return (
    <div className="flex flex-col min-h-screen gap-4 selection:bg-primary selection:text-white dark bg-[#0C0A09] ">
      ...
      <SectionWrapper className="text-center">
        <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl bg-clip-text text-transparent bg-gradient-to-r  from-slate-400 to-slate-500 ">
        ...
        <Link
  className="w-max bg-slate-600 text-white hover:bg-slate-700 transition-colors flex px-4 py-2 rounded-sm items-center"
  href={"/sign-in"}
>
